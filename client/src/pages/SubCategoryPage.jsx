...
const SubCategoryPage = () => {
  ...
  return (
    ...
    <div className='p-4 bg-gradient-to-r from-slate-950 via-slate-900 to-slate-800 shadow-md flex items-center justify-between border-b border-orange-500/30'>
        <h2 className='font-bold text-white text-lg'>Sub Category</h2>

        <button 
            onClick={()=>setOpenAddSubCategory(true)} 
            className='text-sm border border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white px-4 py-2 rounded-full font-semibold transition-all duration-300'
        >
            Add Sub Category
        </button>
    </div>
