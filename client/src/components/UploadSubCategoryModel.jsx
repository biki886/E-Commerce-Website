...
<section className='fixed top-0 right-0 bottom-0 left-0 bg-black bg-opacity-70 z-50 flex items-center justify-center p-4'>
    <div className='w-full max-w-5xl bg-white p-5 rounded-2xl shadow-2xl border border-slate-200'>

        {/* HEADER */}
        <div className='flex items-center justify-between gap-3 border-b border-slate-200 pb-3'>
            <h1 className='font-bold text-slate-800 text-lg'>Add Sub Category</h1>
